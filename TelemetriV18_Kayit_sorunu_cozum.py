...
class Yer_istasyonu(QWidget): #ana kodun olduğu yer
    ...
    def initUI(self):
        ...
        self.zoom_combo.setGeometry(1250, 580, 150, 50)  #
        ...
        self.SeperateButton.setFixedSize(60, 40)
        ...
        self.SeperateButton.setFixedSize(60, 40)
        self.SeperateButton.move(920, 80)
        self.SeperateButton.setFont(QFont('Arial', 10))
        ...
        self.SeperateButton.setFixedSize(60, 40)
        self.SeperateButton.move(990, 80)
        self.SeperateButton.setFont(QFont('Arial', 10))
        self.SeperateButton.clicked.connect(self.button3Clicked)
        self.SeperateButton.show()

        # buton4
        self.SeperateButton = QPushButton('Buton4', self)
        self.SeperateButton.setFixedSize(60, 40)
        self.SeperateButton.move(1060, 80)
        self.SeperateButton.setFont(QFont('Arial', 10))
        self.SeperateButton.clicked.connect(self.button4Clicked)
        self.SeperateButton.show()

        # buton5
        self.SeperateButton = QPushButton('Buton5', self)
        self.SeperateButton.setFixedSize(60, 40)
        self.SeperateButton.move(1130, 80)
        self.SeperateButton.setFont(QFont('Arial', 10))
    ...
    def save_to_excel(self, data):
        try:
            ...
            if len(values) >= 22:
                ...
                df = pd.read_excel(self.excel_file, dtype={'HataK': str})  # HataK sütununu metin olarak yükle
