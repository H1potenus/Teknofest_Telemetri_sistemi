...
class Yer_istasyonu(QWidget): #ana kodumuzun yer aldığı class
    ...
    def initUI(self):
        ...
        self.simulation2D.setGeometry(1100, 200, 150, 150)  # Adjust size and position as needed
        ...
        self.basincGrafik = Grafikler(self, title="basinc graf", xlabel="zaman", ylabel="basinc",           x=370, y=210, width=300, height=200)
        self.hizGrafik = Grafikler(self, title="hiz graf", xlabel="zaman", ylabel="hiz",                    x=730, y=210, width=300, height=200)
        self.yükseklikGrafik = Grafikler(self, title="Yükseklik graf", xlabel="zaman", ylabel="yükseklik",  x=10, y=420, width=300, height=200)
        self.pilGerilimGrafik = Grafikler(self, title="Pil Gerilimi graf", xlabel="zaman", ylabel="gerilim",x=370, y=420, width=300, height=200)
    ...
    def run(self):
        while True:
            try:
                ...
                if self.ser:
                    self.ser.close()
                time.sleep(3)  # Reconnect after a delay
